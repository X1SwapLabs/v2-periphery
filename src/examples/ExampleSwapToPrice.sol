...
contract ExampleSwapToPrice {
    ...
    IX1swapV2Router01 public immutable router;
    address public immutable factory;

    constructor(address factory_, IX1swapV2Router01 router_) public {
        factory = factory_;
        router = router_;
    }
    ...
    function swapToPrice(
        ...
        uint256 amountIn;
        {
            ...
            (aToB, amountIn) = X1swapV2LiquidityMathLibrary.computeProfitMaximizingTrade(
